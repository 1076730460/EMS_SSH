...
<script src="<%=request.getContextPath()%>/resources/js/type.js">
		...
		<table id="dataSourceTable"
			...
			<tbody>
				<tr>
					...
					<td>${type.update_person }</td>
					<td>${type.update_time }</td>
					<td style="text-align: center;"><a id="deltType"
						onclick="deletType('${type.id}')" style="cursor: pointer;">删除</a>
					</td>
				</tr>
			</tbody>
		</table>
